...
<html>
<head>
    <title>AdminApply</title>
    <script type="text/javascript" src="js/AdminApply.js"></script>
</head>
<body>
<h1>申请表</h1>
<%
  ...
  User user = UserService.getUserService().findUserById(user_id);
